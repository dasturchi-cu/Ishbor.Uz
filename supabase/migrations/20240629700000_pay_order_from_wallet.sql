-- Buyurtmani hamyon balansidan to'lash (sandbox / ichki balans)
...
revoke all on function public.pay_order_from_wallet_rpc(uuid, uuid) from public;
grant execute on function public.pay_order_from_wallet_rpc(uuid, uuid) to service_role;
